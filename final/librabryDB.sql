...
('1', '1', '2020-11-4', '2020-12-4', 'NULL'),
('2', '4', '2020-9-5', '2020-10-5', 'NULL'),
('3', '5', '2020-6-5', '2020-7-5', 'NULL'),
('4', '6', '2020-10-5', '2020-11-5', 'NULL'),
('5', '7', '2020-1-1', '2020-2-1', '2020-1-16'),
('6', '8', '2020-4-3', '2020-5-3', '2020-4-20'),
('7', '9', '2020-10-5', '2020-11-5', '2020-11-6'),
('8', '10', '2020-10-5', '2020-11-5', 'NULL'),
('9', '11', '2020-10-5', '2020-11-5', '2020-11-3'),
('10', '12', '2020-10-5', '2020-11-5', 'NULL'),
('1', '2', '2020-11-4', '2020-12-4', 'NULL'),
('1', '3', '2020-11-4', '2020-12-4', 'NULL'),
('15', '13', '2020-11-5', '2020-12-5', 'NULL'),
('14', '14', '2020-9-5', '2020-10-5', '2020-10-1'),
('14', '15', '2020-9-5', '2020-10-5', 'NULL'),
('15', '16', '2020-11-6', '2020-12-7', 'NULL')
GO
...
--	ON tbl_product.ProductAuthor = tbl_author.AuthorID
...
FROM tbl_product JOIN tbl_media
	ON (tbl_product.MediaID = tbl_media.MediaID) 
WHERE MediaType = 'Book' AND ProductGenre = 'Fantasy';
